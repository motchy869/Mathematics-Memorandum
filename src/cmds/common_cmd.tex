...
\newcommand*{\faI}{f_\text{a,I}}
\newcommand*{\faII}{f_\text{a,II}}
\newcommand*{\fd}{{f^{(1)}}}
\newcommand*{\fe}{f_\text{e}}
\newcommand*{\fea}{f_\text{ea}}
\newcommand*{\feb}{f_\text{eb}}
\newcommand*{\fhat}{\hat{f}}
\newcommand*{\fo}{f_\text{o}}
\newcommand*{\foa}{f_\text{oa}}
\newcommand*{\fob}{f_\text{ob}}
\newcommand*{\fs}{f_\text{s}}
\newcommand*{\fsI}{f_\text{s,I}}
\newcommand*{\fsII}{f_\text{s,II}}
