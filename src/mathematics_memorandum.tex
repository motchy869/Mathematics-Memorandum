...
\title{数学備忘録}
\author{motchy}
\date{\西暦2015年5月27日$\sim$ \today \\ver \docVer}
% --------------------
...
\begin{document}
    ...
    \begin{thebibliography}{99}
        ...
        \bibitem{離散数学}Seymour Lipschitz著,成嶋 弘 監訳(2010)『マグロウヒル大学演習 離散数学 コンピュータサイエンスの基礎数学』 オーム社
        \bibitem{A Note on the Eigenvectors of Hadamard Matrices of Order 2^n} R. Yarlagadda, J. Hershey共著``A Note on the Eigenvectors of Hadamard Matrices of Order $2^n$'' \url{https://core.ac.uk/download/pdf/81967428.pdf}
        \bibitem{信号処理備忘録} motchy (2022)『信号処理備忘録v0.4.0』\\ \url{https://github.com/motchy869/Signal-Processing-Memorandum/releases/tag/v0.4.0}
