\chapter{Bessel関数}
    \section{定義}
        $x\in\realNumbers,z\in\complexNumbers$に対して$\NapierE^{iz\sin x}$のFourier級数展開により「$n$次の第一種Bessel関数$J_n(z)$」を次のように定義する。
        \begin{equation}
        ...
        \subsection{簡単化}
            ...
            \[ J_n(z) = \frac{1}{2\pi}\integrate{-\pi}{\pi}{\exp i\parens*{z\sin x -nx}}{}{x} = \frac{1}{2\pi}\integrate{-\pi}{\pi}{\cos\parens*{z\sin x -nx}}{}{x} + \frac{1}{2\pi}\integrate{-\pi}{\pi}{i\sin\parens*{z\sin x -nx}}{}{x} \]
            第1項は偶関数の対称積分であり，第2項は奇関数の対称積分なので0だから結局次のようになる。
            \begin{equation}
                \label{eqn:simplified definition of 1st kind n-th Bessel function}
                J_n(z) = \frac{1}{2\pi}\integrate{-\pi}{\pi}{\cos\parens*{z\sin x -nx}}{}{x} = \frac{1}{\pi}\integrate{0}{\pi}{\cos\parens*{z\sin x -nx}}{}{x}
            \end{equation}
    \section{性質}
    ...
    \section{Maclaurin展開}
        ...
        \[ \NapierE^{iz\sin x} = \exp\parens*{ z\frac{\NapierE^{ix} - \NapierE^{-ix}}{2} } = \sum_{k=0}^\infty \frac{1}{k!} \parens*{\frac{z}{2}}^k (\NapierE^{ix}-\NapierE^{-ix})^k \] %= \sum_{k=0}^\infty \frac{1}{k!} \parens*{\frac{z}{2}}^k \sum_{l=0}^k \combi{k}{l} (-1)^{k-l} \NapierE^{i(2l-k)x}
        $n\geq 0$のとき，$(\NapierE^{ix}-\NapierE^{-ix})^k$の展開で$\NapierE^{inx}$が生じるのは$k=n+2l\;(l=0,1,2,\dotsc)$のときで，その係数は$(-1)^l\combi{k}{l} = (-1)^l\combi{n+2l}{l}$である。
        $n<0$のとき，$(\NapierE^{ix}-\NapierE^{-ix})^k$の展開で$\NapierE^{inx}$が生じるのは$k=-n+2l\;(l=0,1,2,\dotsc)$のときで，その係数は$(-1)^{k-l}\combi{k}{l} = (-1)^{-n+l}\combi{-n+2l}{l}$である。
        式\eqref{eqn:implicit definition of 1st kind n-th Bessel function}の両辺のFourier展開基底の係数同士が一致せねばならぬから
        \[
            J_n(z) =
            \begin{dcases}
                \sum_{l=0}^\infty \frac{(-1)^l}{(n+2l)!}\parens*{\frac{z}{2}}^{n+2l}\combi{n+2l}{l} = \sum_{l=0}^\infty \frac{(-1)^l}{l!(n+l)!}\parens*{\frac{z}{2}}^{n+2l} & (n\geq 0) \\
                \sum_{l=0}^\infty \frac{(-1)^{-n+l}}{(-n+2l)!}\parens*{\frac{z}{2}}^{-n+2l}\combi{-n+2l}{l} = \sum_{l=0}^\infty \frac{(-1)^{-n+l}}{l!(-n+l)!}\parens*{\frac{z}{2}}^{-n+2l} & (n < 0)
            \end{dcases}
        \]