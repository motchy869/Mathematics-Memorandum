    ...
    \section{1次増分}
        ...
        \begin{proof}
            ...
            \begin{align*}
                ...
                &= \frac{1}{2}\underbrace{\left[\partDeriv{\Rf}{x}{}(x,y) - i\partDeriv{\Rf}{y}{}(x,y)\right]}_{\mathrm{(1)}}h + \frac{1}{2}\underbrace{\left[\partDeriv{\Rf}{x}{}(x,y) + i\partDeriv{\Rf}{y}{}(x,y)\right]}_{\mathrm{(2)}}\overline{h} + o(|h|)
            \end{align*}
            ...
            \subsubsection{\texorpdfstring{$\norm{\sum_{i=1}^N X_i\bm{a}_i + \bm{b}}_2^2\;(\bm{a}_i, \bm{b} \in \complexNumbers^n,X_i \in \complexNumbers^{m\times n})$}{行列X1,X2,...,XNの線形結合×ベクトル+定数のノルム}は\texorpdfstring{$X_1,\dotsc,X_N$}{X1,X2,...,XN}に関して凸である。}
                \begin{proof}
                    ...
                    \begin{align*}
                        ...
                        &= \norm{(1-\lambda)\left(\sum_{i=1}^N X_i\bm{a}_i + \bm{b}\right) + \lambda\left(\sum_{i=1}^N Y_i\bm{a}_i + \bm{b}\right)}_2^2 \\
                    ...
                    \begin{align*}
                        ...
                        &= \lambda(1-\lambda)\left[\norm{\sum_{i=1}^N X_i\bm{a}_i + \bm{b}}_2^2 + \norm{\sum_{i=1}^N Y_i\bm{a}_i + \bm{b}}_2^2 - 2\Re{\left(\sum_{i=1}^N X_i\bm{a}_i + \bm{b}\right)^\mathrm{H}\left(\sum_{i=1}^N Y_i\bm{a}_i + \bm{b}\right)}\right] \\
                        &= \lambda(1-\lambda)\norm{\left(\sum_{i=1}^N X_i\bm{a}_i + \bm{b}\right) - \left(\sum_{i=1}^N Y_i\bm{a}_i + \bm{b}\right)}_2^2 \geq 0
                    \end{align*}
                \end{proof}
