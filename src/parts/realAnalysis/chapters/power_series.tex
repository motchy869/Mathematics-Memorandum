\chapter{冪級数関数}
    \section{2次以上の項が\texorpdfstring{$o(x)\;(x\to 0)$}{o(x) (x→0)}であること}
        ...
        \begin{proof}
            ...
            $f(x)$の2次以上の項は
            \[ \abs{\sum_{i=2}^\infty a_i x^i} \leq \sum_{i=2}^\infty |a_i| |x^i| < \sum_{i=2}^\infty \frac{M}{u^i} |x^i| = M\frac{|x|^2/u^2}{1-|x|/u} \]
            であるから$x\neq 0$ならば
            \[ \abs{\sum_{i=2}^\infty a_i x^i}/|x| < \frac{M}{u}\frac{|x|/u}{1-|x|/u} \to 0\; (\text{as } x\to 0) \]
        \end{proof}