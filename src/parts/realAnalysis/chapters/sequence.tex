\chapter{数列}
    ...
    \section{単調性}
        \subsection{\texorpdfstring{$\left(1-\frac{t}{n}\right)^n\;(t\in[0,n])$}{(1-t/n)\string^n (t∈[0,n])}は\texorpdfstring{$n$}{n}に関して単調増加}
            ...
            \begin{proof}
                \quad\par
                $a_n \coloneq \left(1-\frac{t}{n}\right)^n$とする。
        ...
        %     \begin{proof}
        %         \quad\par
        %         $a_n \coloneq \left(1-\frac{1}{n}\right)^n$とする。
        ...
        %     \end{proof}
    \section{極限}
        \subsection{\texorpdfstring{$\lim_{n\rightarrow\infty}\left(1+1/n+\sum_{k=2}^\infty\frac{c_k}{n^k}\right)^n = \NapierE\quad(\sum_{k=2}^\infty c_k\;\;\mathrm{converges})$}{lim\_\{n→∞\} (1 + 1/n + Σ\_\{k=2\}\string^∞ c\_k/n\string^k)\string^n = e (Σ\_\{k=2→∞\}c\_k converges)}}
            \begin{proof}
                \quad\par
            ...
            \end{proof}
        \subsection{\texorpdfstring{$\lim_{n\rightarrow\infty}\left(1+1/n+o(1/n)\right)^n = \NapierE$}{lim\_\{n→∞\} (1+1/n+o(1/n))\string^n = e}}
            \begin{proof}
                \quad\par
                $o(1/n)$の部分を$f(n)$とおく。
