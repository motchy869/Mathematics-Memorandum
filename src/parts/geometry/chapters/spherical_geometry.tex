\chapter{球面幾何学}
    ...
    \section{極三角形の極三角形が元の三角形になること}
        \begin{proof}
            ...
            \[
                \begin{cases}
                    \bracks*{(\overrightarrow{OB}\times\overrightarrow{OC})\times(\overrightarrow{OC}\times\overrightarrow{OA})}\times\overrightarrow{OC} = \bm{0} \\
                    \bracks*{(\overrightarrow{OC}\times\overrightarrow{OA})\times(\overrightarrow{OA}\times\overrightarrow{OB})}\times\overrightarrow{OA} = \bm{0} \\
                    \bracks*{(\overrightarrow{OA}\times\overrightarrow{OB})\times(\overrightarrow{OB}\times\overrightarrow{OC})}\times\overrightarrow{OB} = \bm{0}
                \end{cases}
            \]
            ...
            \begin{align*}
                ...
                \quad &= \braces*{\bracks*{(\overrightarrow{OB}\times\overrightarrow{OC})\cdot\overrightarrow{OA}}\overrightarrow{OC} - \bracks*{(\overrightarrow{OB}\times\overrightarrow{OC})\cdot\overrightarrow{OC}}\overrightarrow{OA}}\times\overrightarrow{OC} = -\braces*{\bracks*{(\overrightarrow{OB}\times\overrightarrow{OC})\cdot\overrightarrow{OC}}\overrightarrow{OA}}\times\overrightarrow{OC}\\
                \quad &= -\braces*{\bracks*{(\overrightarrow{OC}\times\overrightarrow{OC})\cdot\overrightarrow{OB}}\overrightarrow{OA}}\times\overrightarrow{OC} \quad (\text{スカラー三重積の性質を用いた}) \\
                \quad &= \bracks*{\parens*{\bm{0}\cdot{\overrightarrow{OB}}}\overrightarrow{OA}}\times\overrightarrow{OC} = \bm{0}
            \end{align*}
        \end{proof}
