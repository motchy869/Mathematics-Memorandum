\chapter{公式}
    \section{\texorpdfstring{$\sum_{k=1}^n k^2 = n(n+1)(2n+1)/6$}{2乗和の公式}}
        ...
        \begin{proof}
            ...
            \[ T_{n+1} - T_n = (n+1)^2 - \alpha\parens*{(n+1)^3-n^3} = (n+1)^2 + \alpha(3n^3+3n+1) \]
    ...
    \section{\texorpdfstring{$\sum_{k=0}^n (2k+1)^2 = (n+1)(2n+1)(2n+3)/3$}{奇数の2乗和の公式}}
        \begin{proof}
            \begin{align*}
                ...
                &= \frac{1}{3}(n+1)\bracks*{2n(2n+1) + 6n + 3} = \frac{1}{3}(n+1)(2n+1)(2n+3)
            \end{align*}
        \end{proof}
    ...
    \section{M\"obiusの反転公式}
        ...
        \begin{proof}
            ...
            \par
            \begin{align*}
                \prod_{d \mid n} g(n/d)^{\mu(d)} &= \prod_{d \mid n} \parens*{\prod_{e \mid n/d} f(e)}^{\mu(d)} = \prod_{d \mid n} \prod_{e \mid n/d} f(e)^{\mu(d)} = \prod_{\genfrac{}{}{0pt}{}{d,e}{de \mid n}} f(e)^{\mu(d)} \\
