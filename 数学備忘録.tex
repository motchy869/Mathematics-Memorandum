...
\begin{document}
	\title{数学備忘録}
	\author{motchy}
	\date{\西暦 2015年5月27日 $\sim$ \today \\ver 0.12.0}
	\maketitle
	...
	\input{parts/probabilityTheory/probabilityTheory}
	\input{parts/statistics/descriptive/descriptive}
	\input{parts/statistics/inferential/frequentist/frequentist}
	\input{parts/statistics/inferential/Bayesian/Bayesian}
