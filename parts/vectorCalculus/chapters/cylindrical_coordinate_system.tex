\chapter{円柱座標系}
    ...
    \section{単位ベクトルに関する3次元Euclid空間との関係}
        ...
        \begin{proof}
            ...
            よって
            \begin{align}
                \ir &\coloneqq \frac{1}{h_r}\partDeriv{\vr}{r}{} = \dthv{\cosph}{\sinph}{0} = \vix\cosph+\viy\sinph \\
                \iph &\coloneqq \frac{1}{\hph}\partDeriv{\vr}{\varphi}{} = \frac{1}{r}\dthv{-r\sinph}{r\cosph}{0} = -\vix\sinph+\viy\cosph
            \end{align}
            これを逆に解いてみる。\\
