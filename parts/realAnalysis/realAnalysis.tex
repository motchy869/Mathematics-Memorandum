\part{実解析}
	...
	\chapter{Beta関数}
		...
		\section{多変量Beta関数}
			\begin{shadebox}
				...
				\begin{align*}
					...
					&= \integ{x_1=0}{1}{\integ{x_2=0}{1-x_1}{\dotsi\integ{x_{n-1}=0}{1-\sum_{i=1}^{n-1} x_i}{\prod_{i=1}^{n-1} x_i^{\alpha_i-1}\left(1-\sum_{i=1}^{n-2} x_i\right)^{\alpha_n-1}}{x_{n-1}}\dotsi}{x_2}}{x_1}
				\end{align*}
			\end{shadebox}
		\section{多変量Beta関数とGamma関数の関係}
			...
			\end{shadebox}
			\begin{proof}
				\[ \prod_{i=1}^n \Gamma(\alpha_i) = \prod_{i=1}^n \integ{0}{\infty}{x_i^{\alpha_i-1}e^{-x_i}}{x_i} = \integ{x_1=0}{\infty}{\dotsi\integ{x_n=0}{\infty}{\prod_{i=1}^n x_i^{\alpha_i-1}\exp\left(-\sum_{i=1}^n x_i\right)}{x_n}\dotsi}{x_1} \]
				ここで
				\[
					\bm{y} = P\bm{x},\quad
					P \coloneqq
				...
				\begin{align*}
					\prod_{i=1}^n \Gamma(\alpha_i) &= \integ{y_n=0}{\infty}{\integ{y_1=0}{y_n}{\dotsi\integ{y_{n-1}=0}{y_n-\sum_{i=1}^{n-2}y_i}{\prod_{i=1}^{n-1}y_i^{\alpha_i-1}\left(y_n-\sum_{i=1}^{n-1} y_i \right)^{\alpha_n-1} e^{-y_n}|P|^{-1}}{y_{n-1}}\dotsi}{y_1}}{y_n} \\
					&= \integ{y_n=0}{\infty}{e^{-y_n}\integ{y_1=0}{y_n}{\dotsi\integ{y_{n-1}=0}{y_n-\sum_{i=1}^{n-2}y_i}{\prod_{i=1}^{n-1}y_i^{\alpha_i-1}\left(y_n-\sum_{i=1}^{n-1} y_i \right)^{\alpha_n-1}}{y_{n-1}}\dotsi}{y_1}}{y_n}
				\end{align*}
				ここで$y_i = z_iy_n\;(i=1,\dotsc,n-1)$と変数変換すると
				\begin{align*}
					\prod_{i=1}^n \Gamma(\alpha_i) &= \integ{y_n=0}{\infty}{y_n^{\left(\sum_{i=1}^n \alpha_i-1\right)}e^{-y_n}}{y_n}\integ{z_1=0}{1}{\dotsi\integ{z_{n-1}=0}{1-\sum_{i=1}^{n-2}z_i}{\prod_{i=1}^{n-1}z_i^{\alpha_i-1}\left(1-\sum_{i=1}^{n-1} z_i \right)^{\alpha_n-1}}{z_{n-1}}\dotsi}{z_1} \\
	...
	\chapter{微分と積分の関係}
		...
		\section{
			...
			\small{
				\texorpdfstring{$\derivLong{\left(\integ{x_1=0}{x}{\dotsi\integ{x_n=0}{x-x_1-\dotsb-x_{n-1}}{f_1(x_1)\dotsm f_n(x_n)}{x_n}\dotsi}{x_1}\right)}{x}{}$}{} \texorpdfstring{\\}{}
			...
			\begin{proof}
				...
				\begin{align*}
					F(\omega+\domega) &= \integ{x_1=0}{\omega}{\dotsi\integ{x_n=0}{\omega-x_1-\dotsb-x_{n-1}}{f_1(x_1)\dotsm f_n(x_n)}{x_n}\dotsi}{x_1} \\
				...
				\[g_2(\omega,x_1,x_2) \coloneqq \int_{x_3=0}^{\omega-x_1-x_2+\domega}f_3(x_3)\dotsi\int_{x_n=0}^{\omega-x_1-\dotsb-x_{n-1}+\domega}f_n(x_n)\d{x_n}\cdots\d{x_3}\]
				とおけば
				\begin{align*}
