\part{実解析}
	...
	\chapter{微分と積分の関係}
		...
		\section{
			...
			\small{
				\texorpdfstring{$\derivLong{\left(\integ{x_1=0}{x}{\cdots\integ{x_n=0}{x-x_1-\dotsb-x_{n-1}}{f_1(x_1)\dotsm f_n(x_n)}{x_n}\cdots}{x_1}\right)}{x}{}$}{} \texorpdfstring{\\}{}
				\texorpdfstring{$= \int_{x_1=0}^x\cdots\int_{x_{n-1}=0}^{x-x_1-\dotsb -x_{n-2}} f_1(x_1)\dotsm f_{n-1}(x_{n-1})f_n(x-x_1-\dotsb-x_{n-1}) \mathrm{d}x_{n-1}\cdots\mathrm{d}x_{1}$}{}
			}
		}
			\label{重積分の微分}
			\begin{shadebox}
				...
				$f_1(x),\dotsc,f_n(x)$を$\{x|x\geq 0\}$上の連続関数とし、$f(\bm{x})\coloneqq f_1(x_1)\dotsm f_n(x_n),\quad F(\omega) \coloneqq \integ{\Omega}{}{f(\bm{x})}{\bm{x}}$とするとき、次が成り立つ。
			...
			\begin{proof}
				...
				\begin{align*}
					F(\omega+\domega) &= \integ{x_1=0}{\omega}{\cdots\integ{x_n=0}{\omega-x_1-\dotsb-x_{n-1}}{f_1(x_1)\dotsm f_n(x_n)}{x_n}\cdots}{x_1} \\
		...
		\section{
			系\texorpdfstring{\\}{}
			\small{
				\texorpdfstring{$\derivLong{\left(\integ{x_1=-\infty}{\infty}{\cdots\integ{x_n=-\infty}{x-x_1-\dotsb-x_{n-1}}{f_1(x_1)\dotsm f_n(x_n)}{x_n}\cdots}{x_1}\right)}{x}{}$\\}{}
				\texorpdfstring{$= \integ{x_1=-\infty}{\infty}{\cdots\integ{x_{n-1}=-\infty}{x-x_1-\dotsb-x_{n-2}}{f_1(x_1)\dotsm f_{n-1}(x_{n-1})f_n(x-x_1-\dotsb-x_{n-1})}{x_{n-1}}\cdots}{x_1}$}{}
			}
		}
			\label{重積分の微分の系}
			\begin{shadebox}
				...
				$f_1(x),\dotsc,f_n(x)$を$\mathbb{R}$上の連続関数とし、$f(\bm{x})\coloneqq f_1(x_1)\dotsm f_n(x_n),\quad F(\omega) \coloneqq \integ{\Omega}{}{f(\bm{x})}{\bm{x}}$とするとき、次が成り立つ。
				\[\deriv{F(\omega)}{\omega}{} = \integ{\overline{\Omega}^+}{}{f(\bm{x})}{\bm{x}}\]
