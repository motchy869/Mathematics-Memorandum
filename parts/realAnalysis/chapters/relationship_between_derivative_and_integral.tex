\chapter{微分と積分の関係}
    ...
    \section{\texorpdfstring{$\derivLong{\integrate{a}{x}{f(u)}{}{u}}{x}{} = f(x)$}{(d/dx)∫\_a\string^x f(u) du = f(x)}}
        ...
        \begin{proof}
            \begin{equation}
                \derivLong{\integrate{a}{x}{f(u)}{}{u}}{x}{}= \lim_{h\rightarrow0}{\frac{1}{h}\left(\integrate{a}{x+h}{f(u)}{}{u}-\integrate{a}{x}{f(u)}{}{u}\right)} =  \lim_{h\rightarrow0}{\frac{1}{h}\integrate{x}{x+h}{f(u)}{}{u}}
            \end{equation}
