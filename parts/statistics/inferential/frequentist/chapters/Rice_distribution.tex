    ...
    \section{正規分布する成分を持つ2次元ベクトルと定数ベクトルの和のノルムとの関係}
        ...
        \begin{proof}
            ...
            \begin{align*}
                ...
                &= \frac{1}{\sigma^2}\integrate{0}{r}{r'\exp\left(-\frac{1}{2\sigma^2}\left(r'^2+a^2\right)^2\right)\frac{1}{2\pi}\integrate{0}{2\pi}{\exp\left(\frac{ar'\cos\theta}{\sigma^2}\right)}{}{\theta}}{}{r'}
            \end{align*}
        \end{proof}