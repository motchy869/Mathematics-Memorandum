\part{記述統計}
	...
	% 		$P \coloneqq [\bm{p}_{11},\cdots,\bm{p}_{1\nu_1},\cdots,\bm{p}_{\nev 1},\cdots,\bm{p}_{\nev,\nu_\nev}]$とすると$P$は直交行列である。
	% 		$\Lambda_i \coloneqq \diag{\lambda_{i1},\cdots,\lambda_{i\nu_i}}$とし、$\Lambda \coloneqq \diag{\Lambda_1,\cdots,\Lambda_\nev}$とすると$\Sigma_{\DS}$は次のように$P$によって対角化される。
			...
			直交行列$P\coloneqq[\bm{p}_1,\cdots,\bm{p}_n]$と対角行列$\Lambda\coloneqq\diag{\lambda_1,\cdots,\lambda_n}$を用いて$\Sigma_{\DS}$は次のように対角化される。
