\chapter{置換}
    \section{置換の符号の定理}
        \subsection{\texorpdfstring{$\sigma'(i) \coloneqq \sigma(n+1-i)$としたときの$\sgn\parens*{\sigma'}$}{σ'(i) := σ(n+1-i)としたときのsgn(σ')}}
        ...
        \subsection{\texorpdfstring{$\sigma'(i) \coloneqq n+1-\sigma(i)$としたときの$\sgn\parens*{\sigma'}$}{σ'(i) := n+1-σ(i)おしたときのsgn(σ')}}
