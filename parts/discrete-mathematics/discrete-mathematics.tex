\part{離散数学}
	...
	\chapter{数え上げ}
		\section{``for $i=1, \cdots, n(\in \naturalNumbers)$''は``for $d \mid n, \text{ for } i=1,\cdots,n \text{ where } \gcd(i,n)=d$''と同じ}
			...
			次のような使い方が考えられる。
			\begin{itemize}
				\item $\sum_{i=1}^n f(i) = \sum_{d \mid n} \sum_{\genfrac{}{}{0pt}{}{i=1, \cdots, n}{\gcd(i,n)=d}} f(i)$
				\item $\prod_{i=1}^n f(i) = \prod_{d \mid n} \prod_{\genfrac{}{}{0pt}{}{i=1, \cdots, n}{\gcd(i,n)=d}} f(i)$
			\end{itemize}
		\section{包除原理}
